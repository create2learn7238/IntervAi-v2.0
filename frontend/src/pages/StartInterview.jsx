...
import { Mic, MicOff, Volume2, ArrowLeft, ArrowRight, Flag, Check, RotateCcw } from 'lucide-react';
...
export default function StartInterview() {
  ...
  }, [listening, isRecordingIntent, userAnswer, resetTranscript]);
  ...
  }, [transcript, listening, baseAnswer]);
  ...
  const handleMicClick = () => {
    if (isRecordingIntent) {
      ...
      // Ensure video is recording and not restarted if already active
      if (!mediaRecorderRef.current || mediaRecorderRef.current.state === 'inactive') {
        startVideoRecording();
      }
    }
